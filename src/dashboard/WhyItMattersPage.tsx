function IconTwilight({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M6 18h12a4 4 0 0 0 0-8H6a4 4 0 0 0 0 8z"
        stroke="currentColor"
        strokeWidth="1.5"
      />
    </svg>
        ...
        <div className="wim-duck__grid">
          <div className="wim-duck__copy">
            ...
            <p className="wim-prose">
              The &quot;Duck Curve&quot; describes the gap between when the sun
              provides the most energy (midday) and when your home needs it most
              (evening). By shifting your usage, you &quot;flatten the
              duck.&quot;
            </p>
            <div className="wim-callout">
              ...
              <div>
                ...
                <p className="wim-callout__text">
                  This is when the grid is most stressed and energy is most
                  expensive.
                </p>
              </div>
            </div>
          ...
          <div className="wim-duck__chart-card">
            ...
            <div className="wim-duck__chart-inner">
              <div className="wim-duck__chart-head">
                <span className="wim-duck__chart-kicker">
                  Load vs. solar generation
                </span>
                <div className="wim-duck__legend">
                  <span className="wim-duck__legend-item">
                    <span className="wim-legend-dot wim-legend-dot--solar" />{" "}
                    Solar
                  </span>
                  <span className="wim-duck__legend-item">
                    <span className="wim-legend-dot wim-legend-dot--usage" />{" "}
                    Usage
                  </span>
                </div>
              </div>
              <div
                className="wim-duck__bars"
                role="img"
                aria-label="Illustration: solar peaks midday, usage peaks evening"
              >
                <div
                  className="wim-duck__bar wim-duck__bar--neutral"
                  style={{ height: "25%" }}
                />
                <div
                  className="wim-duck__bar wim-duck__bar--neutral"
                ...
                />
                <div
                  className="wim-duck__bar wim-duck__bar--solar"
                  style={{ height: "67%" }}
                />
                <div
                  className="wim-duck__bar wim-duck__bar--solar"
                ...
                />
                <div
                  className="wim-duck__bar wim-duck__bar--usage"
                  style={{ height: "100%" }}
                />
                <div
                  className="wim-duck__bar wim-duck__bar--usage"
      ...
      <section className="wim-flow" aria-labelledby="wim-flow-title">
        <div className="wim-flow__intro">
          ...
          <p className="wim-flow__sub">
            Energy shouldn&apos;t just pass through. Here&apos;s how directing
            the flow can maximize efficiency.
          </p>
        </div>
        <div className="wim-flow__diagram">
          ...
          <div className="wim-flow__node wim-flow__node--battery">
            ...
            <span className="wim-flow__node-title wim-flow__node-title--lg">
              Solar Battery
            </span>
      ...
      <section className="wim-peaker" aria-labelledby="wim-peaker-title">
        <div className="wim-peaker__grid">
          <div className="wim-peaker__copy">
            <div className="wim-badge wim-badge--impact">
              Environmental impact
            </div>
            <h2 id="wim-peaker-title" className="wim-h2 wim-h2--tight">
              Eliminating the{" "}
              <span className="wim-text-danger">Peaker Plants</span>
            </h2>
            <p className="wim-prose">
              When everyone turns on their AC at 6 PM, utilities fire up
              &quot;Peaker Plants.&quot; These are often the oldest, dirtiest
              fossil fuel plants. Shifting your load even a couple of hours
              helps avoid that dirty surge.
            </p>
            <div className="wim-compare">
              <div className="wim-compare__row">
                ...
                <span className="wim-compare__label">
                  Standard grid: fossil-fuel heavy at peak times
                </span>
              </div>
              <div className="wim-compare__row wim-compare__row--renew">
                ...
                <span className="wim-compare__label">
                  Renewable grid: powered by shared sun and storage
                </span>
              </div>
            </div>
          </div>
          <div className="wim-peaker__visual">
            ...
            <blockquote className="wim-quote">
              <p>
                &quot;My home reduced hundreds of kilograms of carbon emissions
                this year just by shifting my dishwasher to run when the sun is
                strongest.&quot;
              </p>
              <footer>Atticus Wong, Goated WattTime user & Contributor</footer>
            </blockquote>
          </div>
        </div>
      </section>
        ...
        <div className="wim-sweet__card">
          ...
          <div className="wim-sweet__inner">
            ...
            <p className="wim-sweet__lede">
              Batteries prefer a steady rhythm. Deep cycles every day shorten
              lifespan. Using high-energy appliances while the sun is out
              preserves your battery for when you truly need it.
            </p>
            <div className="wim-sweet__grid">
              <div className="wim-sweet__tile">
                ...
                <p className="wim-sweet__tile-text">
                  Daytime direct-use can reduce unnecessary cycle wear over
                  time.
                </p>
              </div>
              <div className="wim-sweet__tile">
                ...
                <p className="wim-sweet__tile-text">
                  Avoiding heavy evening discharge keeps cells cooler and safer.
                </p>
              </div>
            </div>
          </div>
