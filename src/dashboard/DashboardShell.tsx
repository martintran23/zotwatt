...
function IconInsights({ className }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M4 19V5M8 17V9m4 8V7m4 10v-6m4 8V11"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
      />
  ...
  return (
    <div className={`sd-app${smsLayout ? " sd-app--sms" : ""}`}>
      ...
      <div className="sd-frame">
        ...
        <div
          className={`sd-main-scroll${fullWidthLayout ? " sd-main-scroll--sms" : ""}`}
        >
          <main
      ...
      {!fullWidthLayout && (
        <div className="sd-mobile-nav" aria-label="Mobile sections">
          <nav className="sd-mobile-nav__inner">
            ...
            {!whyMatters &&
              navItem("forecast", "Forecast", IconInsights, "mobile")}
            {!whyMatters &&
              navItem("impact", "Get Notified", IconBell, "mobile")}
          </nav>
        </div>
      )}
